from src.module.core.driver import DriverHelper, webdriver
from src.module.core.logging import LogHelper
from src.module.core.capture import CaptureHelper
from src.module.core.proxy import ProxyHelper
from src.module.core.file import FileHelper
from src.module.core.http import HttpHelper
from src.module.core.database import *
from browsermobproxy import Server
from src.module.tools import *
...
class Scheduler:
    ...
    def start_DriverHelper(self, job_name, windows_size: tuple or int = None,
                           headless=False, options=None, infobar=True, image=True, mute=False,
        ...
        self._driver = DriverHelper(job_name, options=options, windows_size=windows_size,
                                    headless=headless, mute=mute, image=image,infobar=infobar)
        # 开启实例化图片捕捉
