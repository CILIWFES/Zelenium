...
from src.module.core.file.FileRunner import FileRunner
...
class FileHelper:
    ...
    def put_queue_default(self, file_name, content):
        """
        保存值默认下载路径,执行队列
        :param file_name:
        :param content:
        :return:
        """
        self._working_queue.put((GF.file_path(self.get_job_name()), file_name, content))
        return True
