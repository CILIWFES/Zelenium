            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="input-group panel-heading"
                        ...
                        <select class="chosen-select form-control" data-placeholder="显示全部" style="width: 300px;"
                                name="filterClass" id="filterClass">
                            <option value="">显示全部</option>
                        </select>
                        <label style="color: snow;width: 40px"></label>
                        <label style="color: snow">只看:</label>
                        <select class="chosen-select form-control" data-placeholder="显示全部" style="width: 150px;"
                                name="filterResult" id="filterResult">
                            <option id="filterResultOption" value="显示全部">显示全部</option>
                        </select>
                        <div style="width: 25%; float: right">
                            <label class="form-control">
                                <span class="text-navy">用例数: </span><span class="text-navy b-r"
                                                                          id="filterAll">3</span><span> | </span>
                                <span style="color: green">通过: </span><span style="color: green"
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function generateResult(className, caseResult) {
            ...
            $.each(resultData["testResult"], function (i, n) {
                if ((className === "" || n["className"] === className) && (caseResult === "显示全部" || n["status"] === caseResult)) {
                    filterAll += 1;
                    var status = "";
                    if (n["status"] === '通过') {
                        filterOk += 1;
                        status = "<td><span class='text-navy'>通过</span></td>";
                    } else if (n["status"] === '失败') {
                        filterFail += 1;
                ...
                series: [
                    {
                        ...
                        data: [
                            ...
                            {value: resultData["testPass"], name: '通过'}
                        ],
                        itemStyle: {
                            emphasis: {
                                shadowBlur: 10,
